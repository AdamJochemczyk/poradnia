        ...
        <div className={style.container}>
            ...
            <div>
                <PointWithText
                    ...
                    secondaryText={"Pomogę Ci sprawić, że jedzenie staje się Twoim sprzymierzeńcem"}
                />
                <PointWithText
                    pointNumber={2}
            ...
            <div>
                ...
                <div className={style.box}>
                    <p className={style.box_primary}>Zaburzenia gospodarki węglowodanowej</p>
                    <p>np. cukrzycę typu 1 i 2, insulinoodporność</p>
                </div>
                <div className={style.box}>
                    <p className={style.box_primary}>Zaburzenia gospodarki lipidowej</p>
                    <p>np. zbyt wysokie stężenie nieprawidłowego cholesterolu lub trójglicerydów</p>
                </div>
                <div className={style.box}>
            ...
            <div>
                <p className={style.step}>
                    Zrób pierwszy krok w stronę zdrowia i umów się na konsultację dietetyczną
                </p>
