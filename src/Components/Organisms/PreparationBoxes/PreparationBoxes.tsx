    ...
    <section className={styles.preparation}>
      <div className={styles.box}>
        ...
        <div className={styles.twoListLayout}>
          <ul>
            ...
            <li>
              glukoza, (u osób z grup ryzyka oraz z problemami z glikemia /
              insulina: doustny test tolerancji glukozy, poziom insuliny, HbA1c)
            </li>
        ...
        <div className={styles.box}>
          ...
          <div className={styles.oneListLayout}>
            <ul>
              ...
              <li>
                Dobę przed badaniami nie należy pić alkoholu, wykonywać
                intensywnych ćwiczeń i narażać się na nadmierny stres.
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className={styles.box}>
        <p className={styles.title}>
          Co zrobić, by otrzymać zniżkę 10% na badanie krwi?
        </p>
        <div className={styles.oneListLayout}>
          <ul>
            <li>
            ...
            <li>
              Wydrukuj kartę, uzupełnij swoje dane i zaznacz "<span className={styles.bolder}>X</span>"" przy badaniach, które chcesz wykonać
            </li>
            <li>Z wypełnionym skierowaniem udaj się do najbliższego punktu ŚLA w godzinach ich pracy</li>
            <li>Pokaż wypełnone skierowanie lub zdjęcie wypełnionego skierowania w punkcie pobrań</li>
          </ul>
        </div>
